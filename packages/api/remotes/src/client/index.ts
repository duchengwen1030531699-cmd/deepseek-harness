...
import promptOptimizerRemote from '@deepseek-ai/dsh-prompt-optimizer/remote'
...
export type {} from '@deepseek-ai/dsh-prompt-optimizer/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, messageFeedbackRemote, promptOptimizerRemote,
