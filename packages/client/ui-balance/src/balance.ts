...
/**
 * Fetch one balance endpoint as JSON text without following redirects.
 * @param url - Exact DeepSeek API URL to request.
 * @param headers - Request headers, including the host-resolved authorization value.
 * @returns The status and unparsed response body for BalanceReader to validate.
 */
