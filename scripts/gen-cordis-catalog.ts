...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  promptOptimizer: 'prompt-optimizer.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PromptOptimizeEmpty: 'prompt-optimizer.md',
  PromptOptimizeFailure: 'prompt-optimizer.md',
  PromptOptimizeLlmFailed: 'prompt-optimizer.md',
  PromptOptimizeRejected: 'prompt-optimizer.md',
  PromptOptimizeRequest: 'prompt-optimizer.md',
  PromptOptimizeResult: 'prompt-optimizer.md',
  PromptOptimizeRouteUnavailable: 'prompt-optimizer.md',
  PromptOptimizeSuccess: 'prompt-optimizer.md',
  PromptOptimizeValue: 'prompt-optimizer.md',
